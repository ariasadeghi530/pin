    ...
    <div className={classes.root}>
      <ExpansionPanel expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        >
          ...
          <Typography className={classes.secondaryHeading}>Change Email, Password, and Contact Information</Typography>
        </ExpansionPanelSummary>
      ...
      <ExpansionPanel expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        ...
        >
          ...
          <Typography className={classes.secondaryHeading}>
            Click here to send an email to our admin.
          </Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails>
          <Typography>
      ...
      <ExpansionPanel expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        ...
        <ExpansionPanelDetails>
          <Typography>
            To review our data policy and opt out of data collection, click here.
          </Typography>
        </ExpansionPanelDetails>
      </ExpansionPanel>
    </div>
